    ...
    <div className=' bg-black w-full h-screen'>
       ...
       <h1 className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 text-5xl p-2 lg:text-8xl  sm:text-6xl ">Situational ComeBacks</h1> 
        ...
        <div className='flex justify-center items-center flex-col lg:flex-row'>
            ...
            <div className='bg-gradient-to-tl from-lime-200 via-sky-500 to-violet-500 bg-zinc-200  rounded-xl flex items-center justify-around flex-col m-10 lg:w-96  shadow-lg shadow-cyan-500/50'>
            ...
            <div className='bg-gradient-to-l from-gray-200 via-fuchsia-200 to-stone-100 m-10 rounded-xl flex items-center flex-col justify-around bg-cyan-500 shadow-lg shadow-cyan-500/50 lg:w-96'>
            ...
            <div className='bg-gradient-to-t rounded-xl flex flex-col lg:w-96 items-center justify-between from-red-700 via-rose-600 to-pink-500 m-10 bg-cyan-500 shadow-lg shadow-cyan-500/50'>
