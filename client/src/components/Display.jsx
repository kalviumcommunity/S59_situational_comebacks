                    ...
                    filteredAtUserData.length > 0 ? (
                        ...
                        <div className='flex items-center justify-center'>
                            ...
                            <button disabled={deleteInProgress} className="inline-flex items-center m-2  p-2 text-sm font-medium text-center text-white bg-red-700 rounded-lg hover:bg-red-800 focus:ring-4 hover:scale-110 transform transition duration-y focus:outline-none focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800" onClick={() => { CompId(e._id), CompUser(e.user), handleDeleteStart() }}>Delete</button>
                             ...
                             { e.user.startsWith('@')&&( <div className='flex items-center justify-center'> <button disabled={deleteInProgress} onClick={() => handleContribute(e.user, e._id)} className='inline-flex items-center m-2 p-2 px-4 text-sm font-medium text-center text-white bg-green-500 rounded-lg hover:bg-green-800 focus:ring-4 hover:scale-110 transform transition duration-y focus:outline-none focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800'>Collab</button>
