  ...
  return (
    <div className=' bg-black w-full h-screen overflow-auto'>
       ...
       <h1 className="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400 text-5xl p-2 lg:text-8xl  sm:text-6xl ">Situational ComeBacks</h1> 
        <h4 className='text-sxl p-2 text-white  font-normal sm:p-10  '>"Do you want to have some good ComeBacks during random moments in front of your family, friends or lover"</h4>
        <h2 className='  text-gray-500 text-2xl p-2 font-semibold dark:text-gray-400 sm:text-3xl lg:text-4xl '>Then you are at the right place</h2>
